...
Plugin URI: http://wpandmore.info/sviluppo-tassionomie-custom/
Description: Questo plugin mi consente di aggiungere nuove tassionomie per i miei articolo e CPT
Version: 0.1
...
function tassionomia_custom() {
	...
	register_taxonomy( 'prodotti', array( 'post' ), $args );
